OBJECTS = main.o Login.o Member.o  UndergraduateStudent.o GraduateStudent.o Student.o Professor.o #Request.o ClassroomRentRequest.o ImprovementRequest.o ConsultingRequests.o CertificateIssuing.o
...
#ConsultingRequests.o : ConsultingRequests.cpp
